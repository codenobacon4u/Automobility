...
public enum AutomobilityEntities {;
    public static final Eventual<EntityType<AutomobileEntity>> AUTOMOBILE = RegistryQueue.register(BuiltInRegistries.ENTITY_TYPE,
            ...
            () -> Platform.get().entityType(MobCategory.MISC, AutomobileEntity::new, new EntityDimensions(1f, 0.66f, 0.66f * 0.85f, EntityAttachments.createDefault(1f, 0.66f), true), 3, 10)
    );
